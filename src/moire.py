...
To run:
First start the gl simulator using the included "moire" layout

    make
    bin/gl_server layouts/moire.json

Then run this script in another shell to send colors to the simulator

    python_clients/moire.py
...
n_pixels = 2048  # number of pixels in the included "moire" layout
fps = 20         # frames per second

# how many sine wave cycles are squeezed into our n_pixels
# 24 happens to create nice diagonal stripes on the moire layout
freq_r = 24
freq_g = 24
freq_b = 24
